...
| `scantobid-wordmark.png` | The lockup at 2×, for anywhere that will not take an SVG. |
...
`scantobid-icon-1024.png` with no alpha channel, which is what the App Store
